...
class _CustomerListState extends State<CustomerList> {
  ...
  late List<CustomerModel> displayedCustomers;
  ...
  void _updateDisplayedCustomers() {
    ...
    final endIndex =
        startIndex + itemsPerPage > widget.customers.length
            ? widget.customers.length
            : startIndex + itemsPerPage;

    if (startIndex >= widget.customers.length) {
      displayedCustomers = [];
    } else {
      displayedCustomers = widget.customers.sublist(startIndex, endIndex);
    }
  }
                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        if (customer.telefone != null &&
                                            customer.telefone!.isNotEmpty) ...[
                                          const SizedBox(height: 4),
                                          Row(
                                            children: [
                                              Icon(
  ...
  Widget _buildPagination() {
    return Row(
      ...
      children: [
        ...
        Spacer(),
        Text(
          'Total de clientes: ${widget.totalItems}',
