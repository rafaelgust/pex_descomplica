...
class _EditSupplierDialogState extends State<EditSupplierDialog> {
  ...
  void initState() {
    ...
    _registerController.text = widget.supplier.register;
    _telefoneController.text = widget.supplier.telefone ?? '';
    _emailController.text = widget.supplier.email ?? '';
    _cepController.text = widget.supplier.cep ?? '';
    _isCNPJ = widget.supplier.type == 'Juridico';
  }
        ...
        .then((value) {
          if (!value) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Erro ao alterar fornecedor')),
            );
          } else {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Fornecedor alterado com sucesso')),
            );
